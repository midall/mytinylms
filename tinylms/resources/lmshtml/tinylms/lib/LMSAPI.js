/*
 * @(#)lmsapi.js 2.1.1 2011-01-30
 *
 * Copyright (c) 2003-2011 Werner Randelshofer
 ...
 * @version
 * 2.1.1 2011-01-30 Fixes a typo in the log.
...
LMSAPI.prototype.loadDatabaseFromCookie = function() {
  LoggerSingleton.write(LoggerSingleton.INTERNAL,"lms.loadDatabaseFromCookie");
  this.resetDatabase();
...
LMSAPI.prototype.LMSInitialize = function(anEmptyString) {
  ...
  if (!this.isLoggedIn()) {
    // FIXME - We should check here if the LMSAPI was not launched properly
    //         due to a page refresh, and then try to log in with the current
    //         user.
    this.gotoLogin();
