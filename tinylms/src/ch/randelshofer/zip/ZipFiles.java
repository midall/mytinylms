/*
 * @(#)ZipFiles.java  2.3  2011-03-29
 *
 * Copyright (c) 2004-2011 Werner Randelshofer
 ...
 * @version 2.3 2011-03-29 Method zip can also work with a folder.
 * <br>2.2 2008-12-03 Added support for ZipIn.
...
public class ZipFiles {
    ...
    throws IOException {
        zip(file,(ZipOut)new ZipOutStream(out),fileName);
    }
    /**
     * Adds the contents of the file to the zip file using the specified name.
     * Prepends the specified directory name to the zip entry names.
