...
implements MutableTableModel {
     ...
     */
    protected ArrayList columnClasses;
     ...
     */
    private static ArrayList createList(int size) {
    ...
    public DefaultMutableTableModel(int rowCount, int columnCount) {
        this(createList(columnCount), rowCount);
    }
    ...
    public DefaultMutableTableModel(Object[][] dataList, Object[] columnNames, Class[] columnClasses) {
        setDataVector(dataList, columnNames);
        this.columnClasses = new ArrayList(Arrays.asList(columnClasses));
    }
     ...
     */
    public DefaultMutableTableModel(List columnNames, int rowCount) {
     ...
     */
    public DefaultMutableTableModel(List dataList, List columnNames) {
        setDataVector(dataList, columnNames);
    }
    ...
    public void setDataVector(List dataVector, List columnIdentifiers) {
        this.dataList = (dataVector == null) ? new ArrayList() : new ArrayList(dataVector);
        this.columnIdentifiers = (columnIdentifiers == null) ? new ArrayList() : new ArrayList(columnIdentifiers);
    ...
    public void setDataVector(Object[][] dataVector, Object[] columnIdentifiers) {
        ArrayList l = new ArrayList(dataVector.length);
        for (int i=0; i < dataVector.length; i++) {
            l.add(new ArrayList(Arrays.asList(dataVector[i])));
        }
        setDataVector(l, new ArrayList(Arrays.asList(columnIdentifiers)));
    }
    ...
    throws UnsupportedFlavorException, IOException {
        ...
        try {
            ...
            for (int i=0; i < transferData.length; i++) {
                dataList.add(row + i, new ArrayList(Arrays.asList(transferData[i])));
            }
    ...
    public Object getValueAt(int row, int column) {
        ArrayList rowList = (ArrayList) dataList.get(row);
    ...
    public void addRow(int row, Object element) {
        ...
        dataList.add(row, new ArrayList(Arrays.asList((Object[]) element)));
