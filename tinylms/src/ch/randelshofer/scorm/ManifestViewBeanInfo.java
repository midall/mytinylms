/*
 * @(#)ManifestViewBeanInfo.java 1.0  2003-11-01
 *
...
public class ManifestViewBeanInfo extends SimpleBeanInfo {
    ...
    private static BeanDescriptor getBdescriptor(){
        ...
        // Here you can add code for customizing the BeanDescriptor.
         if (beanDescriptor == null) beanDescriptor = new BeanDescriptor(ManifestViewBeanInfo.class);
