...
public class SchemaVersionElement extends AbstractElement {
    ...
    throws IOException, ParserConfigurationException, SAXException {
        ...
        if (! elem.getLocalName().equals("schemaversion")) {
                throw new IOException("'" + getRequiredNamespace() + ":schemaversion' element expected, but found '"+namespace+":"+elem.getTagName()+"' element.");
        }
