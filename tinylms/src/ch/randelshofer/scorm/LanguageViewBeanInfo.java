/*
 * @(#)LanguageViewBeanInfo.java 1.0  2003-08-22
 *
...
public class LanguageViewBeanInfo extends SimpleBeanInfo {
    ...
    private static BeanDescriptor getBdescriptor(){
        ...
        // Here you can add code for customizing the BeanDescriptor.
         if (beanDescriptor == null) beanDescriptor = new BeanDescriptor(LanguageViewBeanInfo.class);
