/*
 * @(#)LayoutViewBeanInfo.java 1.0  2003-05-07
 *
...
public class LayoutViewBeanInfo extends SimpleBeanInfo {
    ...
    private static BeanDescriptor getBdescriptor(){
        ...
        // Here you can add code for customizing the BeanDescriptor.
         if (beanDescriptor == null) beanDescriptor = new BeanDescriptor(LayoutViewBeanInfo.class);
